...
تصل الرسالة كجدول Rich Message حقيقي. التعليقات تستخدم صف عنوان مدمج باسم **تعليق جديد** وتحته تفاصيل التعليق. وعند الـPush يظهر **Push جديد** مع المستودع والفرع والناشر وقائمة الـCommits في رسالة واحدة. اسم المستودع زر غني داخل خلية الجدول، وأسفل الجدول يظهر تذييل GitSpy وزر الحدث نفسه.
